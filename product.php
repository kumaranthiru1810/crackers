                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            ...
                            <form action="" method="post">
                                ...
                                <p style="font-size: 25px;">₹<?php echo $p_current_price; ?></p>
                                <div class="p-quantity">
...
<div class="container">
    <h1>Do's</h1>
    <p><b>Read and follow instructions:</b> Always read the instructions provided by the manufacturer on how to safely handle and fire the crackers.
        <br>
        <b>Use in open spaces:</b> Firecrackers should be lit in open areas away from buildings, dry leaves, and other flammable materials. A clear, open space minimizes the risk of fires spreading.
        <br>
        <b>Keep water nearby:</b> Have a bucket of water, a fire extinguisher, or a hose nearby in case of any accidents or emergencies.
        <br>
        <b>Light only one at a time:</b> Avoid lighting multiple crackers simultaneously to prevent unexpected explosions or accidents.
        <br>
        <b>Wear protective gear:</b> If possible, wear safety glasses and gloves while handling fireworks to protect your eyes and hands from sparks and debris.
        <br>
        <b>Supervise children:</b> If children are present, make sure they are supervised by responsible adults when handling or watching fireworks.
        <br>
        <b>Dispose of properly:</b> After firing crackers, make sure to properly dispose of any debris or used fireworks. Soak used fireworks in water before disposing of them in a trash container.
    </p>
</div>
...
<div class="container">
    <h1>Don't</h1>
    <p>
        <b>Don't light indoors:</b> Never light fireworks indoors, as confined spaces can amplify the risk of accidents and injuries.
        <br>
        <b>Don't relight duds:</b> If a firework fails to ignite, do not attempt to relight it. Wait at least 15 to 20 minutes, then soak it in water before disposing of it properly.
        <br>
        <b>Don't point at people or property:</b> Never aim or throw fireworks at people, animals, or property. This can cause serious harm or damage.
        <br>
        <b>Don't mix alcohol and fireworks:</b> Avoid consuming alcohol while handling fireworks, as it impairs judgment and coordination, increasing the risk of accidents.
        <br>
        <b>Don't allow children to handle fireworks:</b> Fireworks can be dangerous, and children should never be allowed to handle them without adult supervision.
        <br>
        <b>Don't store near heat sources:</b> Keep fireworks away from heat sources, such as stoves, grills, or heaters, as they can ignite accidentally.
        <br>
        <b>Don't use damaged fireworks:</b> Discard any fireworks that appear damaged, as they may malfunction and cause accidents.
    </p>
</div>
